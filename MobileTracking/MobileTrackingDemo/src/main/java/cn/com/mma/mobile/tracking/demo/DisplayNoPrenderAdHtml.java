 ...
 */
public class DisplayNoPrenderAdHtml extends Activity {

    private static final String Faile_HTML_URL = "http://omi-api-test.cn.miaozhen.com/btr-beta/plan-b/html_Img_error.html";
    ...
    public void init(){
        ...
        Countly.sharedInstance().webViewImp(EXPOSE_URL, webView, 0, false,new CallBack() {
            @Override
        ...
        try {
            webView.loadUrl(Faile_HTML_URL);
