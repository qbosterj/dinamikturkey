...
//        videoView.setVideoPath(videoPath);
        ...
        try {
            ...
            Countly.sharedInstance().videoImp(VIDEO_EXPOSE_URL, videoView, 1, 1, new CallBack() {
                @Override
...
//            });
    ...
    View.OnTouchListener videoClickListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            if (mGesture == null) {
                mGesture = new GestureDetector(ClickVideoActivity.this, new GestureDetector.SimpleOnGestureListener() {
                    @Override
                ...
                mGesture.setOnDoubleTapListener(new GestureDetector.OnDoubleTapListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        toLandingPage(ClickVideoActivity.this, VIDEO_CLICK_URL);
                        return true;
                    }
