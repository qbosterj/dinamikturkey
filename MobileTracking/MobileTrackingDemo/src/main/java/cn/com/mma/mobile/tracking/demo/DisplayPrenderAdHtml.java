 ...
 */
public class DisplayPrenderAdHtml extends Activity {


//    private static final String Sucess_HTML_URL = "http://omi-api-test.cn.miaozhen.com/btr-beta/plan-b/html_img.html";
    private static final String Sucess_HTML_URL = "http://103.44.251.8:8080/";
...
//        finish();
    ...
    public void init(){
        ...
        Countly.sharedInstance().webViewImp(EXPOSE_URL, webView, 1,false, new CallBack() {
            @Override
...
//                Countly.sharedInstance().StartInjectJavascript(getApplicationContext(),webView);
//                Logger.i("页面加载成功！！！:" + webView.hashCode());
